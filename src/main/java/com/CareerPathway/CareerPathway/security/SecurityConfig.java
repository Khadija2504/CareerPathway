    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/user/**", "/api/courses/employee/**", "/api/mentorship/mentor/**", "/api/resources/user/**", "/api/courses/**", "/api/mentorship/user/**", "api/admin/aggregated-results").authenticated()
