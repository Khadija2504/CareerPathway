    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/courses/admin/**", "/api/resources/admin/**", "/api/employee/goal/GoalSupported/**", "/api/employee/goal/allGoals", "/api/careerPath/admin/**", "/api/employee/skills/admin/**", "/api/employee/questionnaires/admin/**", "api/admin/**").hasRole("ADMIN")
